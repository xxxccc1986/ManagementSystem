    ...
    <div style="color:whitesmoke; font-weight: bold;font-size: 30px; text-align: center;padding: 30px">
      ...
      <el-form ref="form" :model="form" size="normal" :rules="rules">
        <el-form-item prop="username">
          <el-input prefix-icon="UserFilled" v-model="form.username" placeholder="请输入要找回的账户名" ></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input prefix-icon="Lock" v-model="form.password" placeholder="新密码" show-password="false"></el-input>
        </el-form-item>
        ...
        <el-form-item>
            <el-button type="primary" @click="setPassword" style="width: 100%">重置密码</el-button>
        </el-form-item>
        <el-form-item>
  ...
  methods:{
    ...
    setPassword(){
      this.$refs['form'].validate((valid) => {
        //合法
        if (valid) {
          request.put("/admin/resetPassword",this.form).then(res =>{
            if (res.code === 200){
              this.$message({
                type: "error",
